    ...
    public partial class Form1 : Form
    {
        ...
        private void UpdateInstrument_Click(object sender, EventArgs e)
        {
            try {
                ...
                DataSet1.BillRow br = dataSet1.Bill.NewBillRow();
                br["tableNumber"] = 1;
                br["date"] = new DateTime(2008, 5, 1, 8, 30, 52);
                br["total"] = 0;
                dataSet1.Bill.AddBillRow(br);

                br = dataSet1.Bill.NewBillRow();
                br["tableNumber"] = 3;
                ...
                br = dataSet1.Bill.NewBillRow();
                br["tableNumber"] = 10;
                br["date"] = new DateTime(2020, 10, 10, 14, 30, 52);
                br["total"] = 0;
                dataSet1.Bill.AddBillRow(br);

                DataSet1.DishRow dr = dataSet1.Dish.NewDishRow();
                dr["name"] = "Potato";
                dr["price"] = 50;
                dataSet1.Dish.AddDishRow(dr);

                dr = dataSet1.Dish.NewDishRow();
                dr["name"] = "pain";
                dr["price"] = 0;
                dataSet1.Dish.AddDishRow(dr);
                ...
                DataSet1.OrderRow or = dataSet1.Order.NewOrderRow();
                or["billid"] = 1;
                or["dishid"] = 1;
                or["count"] = 2;
                or["total"] = 0;
                dataSet1.Order.AddOrderRow(or);

                or = dataSet1.Order.NewOrderRow();
                or["billid"] = 2;
                or["dishid"] = 4;
                or["count"] = 5;
                or["total"] = 0;
