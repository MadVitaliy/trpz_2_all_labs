    ...
    public partial class Form1 : Form
    {
        ...
        private void Create_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // TODO: данная строка кода позволяет загрузить данные в таблицу "lab7_2DataSet.SERVICE". При необходимости она может быть перемещена или удалена.
                this.sERVICETableAdapter.Fill(this.lab7_2DataSet.SERVICE);
                // TODO: данная строка кода позволяет загрузить данные в таблицу "lab7_2DataSet.EMPLOYEE". При необходимости она может быть перемещена или удалена.
                this.eMPLOYEETableAdapter.Fill(this.lab7_2DataSet.EMPLOYEE);
                // TODO: данная строка кода позволяет загрузить данные в таблицу "lab7_2DataSet.CAR". При необходимости она может быть перемещена или удалена.
                this.cARTableAdapter.Fill(this.lab7_2DataSet.CAR);
        ...
        private void UpdateInstrument_Click(object sender, EventArgs e)
        {
            try {
                ...
                ////carDataSet.CAR.Ide
                cARTableAdapter.Adapter.Update(this.lab7_2DataSet.CAR.DataSet);
                sERVICETableAdapter.Adapter.Update(this.lab7_2DataSet.SERVICE.DataSet);
                eMPLOYEETableAdapter.Adapter.Update(this.lab7_2DataSet.EMPLOYEE.DataSet);

                this.lab7_2DataSet.CAR.Clear();
                this.lab7_2DataSet.SERVICE.Clear();
                this.lab7_2DataSet.EMPLOYEE.Clear();

                cARTableAdapter.Adapter.Fill(this.lab7_2DataSet.CAR.DataSet);
                sERVICETableAdapter.Adapter.Fill(this.lab7_2DataSet.SERVICE.DataSet);
                eMPLOYEETableAdapter.Adapter.Fill(this.lab7_2DataSet.EMPLOYEE.DataSet);
            }
            catch (Exception ex)
            {
                MessageBox.Show(
