...
exec sp_helpdb Lab1
go
alter database Lab1 modify name = Lab1ClassWork
go

--delete database
--use master
--drop database Lab1ClassWork;
...
(
	...
	Nadbavka money NOT NULL,
	DataVuplaty date NULL,
...
INSERT INTO Employee (Surname, Name, Patronymic, DutiesId, BirthdayCity, Birthday, Oklad, Nadbavka, DataVuplaty) VALUES
